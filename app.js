...
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//rawcdn.githack.com/asiatismo/goindex/b46bb643bb1c1314b669142e5e62d96a877b952b/css/mdui_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//rawcdn.githack.com/asiatismo/goindex/b46bb643bb1c1314b669142e5e62d96a877b952b/css/mdui_v2.min.css">'
  );
}
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//rawcdn.githack.com/asiatismo/goindex/f9af6b2192974a4a9c1b222efed8d29ca6cd1927/css/nexmoe_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//rawcdn.githack.com/asiatismo/goindex/f9af6b2192974a4a9c1b222efed8d29ca6cd1927/css/nexmoe_v2.min.css">'
  );
}
document.write(
  '<script src="//rawcdn.githack.com/asiatismo/goindex/295ceaf2d64b2cb8578b21c0313d75b7bc8738a1/js/mdui.min.js"></script>'
);
document.write(
  '<script src="//rawcdn.githack.com/asiatismo/goindex/295ceaf2d64b2cb8578b21c0313d75b7bc8738a1/js/flv.min.js"></script>'
);
document.write(
  '<script src="//rawcdn.githack.com/asiatismo/goindex/295ceaf2d64b2cb8578b21c0313d75b7bc8738a1/js/DPlayer.min.js"></script>'
);
document.write(
...
<div class="mdui-container">
  ...
  if (UI.credits) {
    ...
    <div style="margin-bottom: 20px" class="mdui-center mdui-text-center">
      <a href="https://github.com/asiatismo/" target="_blank">
        <img src="https://img.shields.io/static/v1?label=asiatismo&amp;message=goindex&amp;color=1E89F2&amp;labelColor=374455&amp;logo=github" alt="asiatismo - goindex">
      </a>
    </div>
    </div>
    `
  ...
  var search_bar = `<div class="mdui-toolbar-spacer"></div>
        <div id="search_bar" class="mdui-textfield mdui-textfield-expandable mdui-float-right ${
          model.is_search_page ? "mdui-textfield-expanded" : ""
            ...
            <input class="mdui-textfield-input" type="text" name="q" placeholder="Buscar en el índice actual" value="${search_text}"/>
            </form>
...
function append_files_to_list(path, files) {
  ...
  for (i in files) {
    ...
    if (item.mimeType == "application/vnd.google-apps.folder") {
      ...
      var p = path + encodeURIComponent(item.name).replaceAll("%5C", "%5C%5C").replace(/[!'()*]/g, escape);	// Adding Nombre del Archivo to url
      var ddl_link = p;
...
function onSearchResultItemClick(a_ele) {
  ...
  var dialog = mdui.dialog({
    title: "",
    content:
      '<div class="mdui-text-center mdui-typo-title mdui-m-b-1">Obteniendo la Ruta de Destino...</div><div class="mdui-spinner mdui-spinner-colorful mdui-center"></div>',
    history: !1,
    modal: !0,
    closeOnEsc: !0,
  });
...
<script src="//cdn.jsdelivr.net/gh/asiatismo/goindex/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/asiatismo/goindex/js/ext-language_tools.js"></script>
	`;
  $("#content").html(content);
...
function file_video(path) {
  ...
  const playBtn = `
      <button class="mdui-btn mdui-ripple mdui-color-theme-accent" mdui-menu="{target:'#player-items'}">
        <i class="mdui-icon material-icons">&#xe039;</i>Reproducir en App Externa<i class="mdui-icon material-icons">&#xe5cf;</i>
      </button>
            ...
            <div class="mdui-container">
                <div class="mdui-row-xs-2 mdui-m-b-1">
                    <div class="mdui-col">
                        ${
                          prev_child
                            ? `<button id="leftBtn" data-filepath="${prev_child}" class="mdui-btn mdui-btn-block mdui-color-theme-accent mdui-ripple">Anterior</button>`
                            : `<button class="mdui-btn mdui-btn-block mdui-color-theme-accent mdui-ripple" disabled>Anterior</button>`
                        }
                    </div>
                    <div class="mdui-col">
                        ${
                          next_child
                            ? `<button id="rightBtn" data-filepath="${next_child}" class="mdui-btn mdui-btn-block mdui-color-theme-accent mdui-ripple">Siguiente</button>`
                            : `<button class="mdui-btn mdui-btn-block mdui-color-theme-accent mdui-ripple" disabled>Siguiente</button>`
                        }
                    </div> 
                </div>
            </div>
