const authConfig = {
  "siteName": "亞洲主義", // WebSite Name
  "siteIcon": "https://cdn.jsdelivr.net/gh/asiatismo/goindex@main/images/favicon.png", //or fevicon-x-light.png
...
const uiConfig = {
  ...
  "hide_readme_md": true, // Set this to true if you need to disable rendering README.md
  ...
  "footer_text": "Hecho con Cafeína", // Provide the footer text. Leave this empty if you want to hide it.
...
<head>
  ...
  <script rel="preconnect" src="//cdn.jsdelivr.net/gh/asiatismo/goindex@main/app.js"></script>
</head>
<body>
</body>
</html>
